...
class TransformerJsonApiSerializer extends ArraySerializer
{
    protected $baseUrl;
    ...
    public function paginator(PaginatorInterface $paginator)
    {
        ...
        $from = ((int) $paginator->getCurrentPage() * (int)$paginator->getPerPage())-((int)$paginator->getPerPage()-1);
        $to = (int) $paginator->getCurrentPage() * (int)$paginator->getPerPage();
